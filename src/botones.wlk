...
const finalizarJuego = new Seleccionar(presione = "Tecla control", position = game.at(4, 5), image = "finalizarJuego.png")

const volver = new Seleccionar(presione = "Tecla Del", position = game.at(15, 1), image = "volver.png")

const continuar = new Seleccionar(presione = "Tecla Alt", position = game.at(1, 1), image = "continuar.png")
